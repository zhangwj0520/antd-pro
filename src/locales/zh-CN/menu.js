export default {
  ...
  'menu.bund': '账单管理',
  'menu.bund.bundlist': '账单列表',
  'menu.file.test': '测试',
  'menu.bund.bundlist.all': '所有账单',
  'menu.bund.bundlist.detail': '详细账单',
  'menu.file': '文件管理',
  'menu.file.upload': '文件上传',
  'menu.auth': '权限管理',
  'menu.auth.adduser': '添加用户',
  'menu.auth.auth': '配置权限',
  'menu.chart': '图表',
  'menu.chart.curved': '折线图',
  'menu.chart.mycurved': '折线图2',
  'menu.list': '列表页',
